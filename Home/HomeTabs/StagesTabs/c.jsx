...
const ApplicationForm = () => {
  const [showDateNaissance, setShowDateNaissance] = useState(false);
      ...
      >
        {({ handleChange, handleBlur, handleSubmit, values, setFieldValue, errors, touched }) => (
          <View style={{ padding: 20 }}>
            ...
            <Button onPress={() => setShowDateNaissance(true)}>
              Sélectionner la date de naissance
            </Button>
            <Text>{values.date_naissance.toLocaleDateString()}</Text>
            {showDateNaissance && (
              <DateTimePicker
                ...
                onChange={(event, selectedDate) => {
                  setShowDateNaissance(Platform.OS === 'ios');
                  if (selectedDate) {
            ...
            <Button onPress={() => setShowDateDebut(true)}>
              Sélectionner la date de début souhaitée
            </Button>
            <Text>{values.date_debut.toLocaleDateString()}</Text>
            {showDateDebut && (
              <DateTimePicker
